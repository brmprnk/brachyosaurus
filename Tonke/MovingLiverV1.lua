...
initposV = 5           -- initial position (5V = 25mm)
...
while true do
  if LJ.CheckInterval(0) then                   --interval completed
    ...
    setpointV = (amplitude/5) * math.sin(frequency*rads)                           -- calcultate new setpoint
    rads = rads + radstep
    ...
    intterm = setpointV
    err = setpointV - inputV + 5                -- calculate error signal (mind the 5V offset!)
