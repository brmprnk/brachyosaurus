...
try
    ...
    LabJack.LJM.eWriteName(handle, 'STREAM_OUT0_LOOP_SIZE', 6);
    LabJack.LJM.eWriteName(handle, 'STREAM_OUT0_BUFFER_F32', 0.0);  % 0.0 V
    LabJack.LJM.eWriteName(handle, 'STREAM_OUT0_BUFFER_F32', 1.0);  % 1.0 V
    LabJack.LJM.eWriteName(handle, 'STREAM_OUT0_BUFFER_F32', 2.0);  % 2.0 V
    LabJack.LJM.eWriteName(handle, 'STREAM_OUT0_BUFFER_F32', 3.0);  % 3.0 V
    LabJack.LJM.eWriteName(handle, 'STREAM_OUT0_BUFFER_F32', 4.0);  % 4.0 V
    LabJack.LJM.eWriteName(handle, 'STREAM_OUT0_BUFFER_F32', 5.0);  % 5.0 V
